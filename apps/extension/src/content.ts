...
// Includes Base Pay integration for seamless crypto payments
  ...
  const utils = {
    ...
    setCheckoutButtonsLoadingState(isLoading: boolean): void {
      const buttons = [
        ...
        document.getElementById('amazon-basepay-button')
      ];
    ...
    // Create Base Pay button
    createBasePayButton(): HTMLElement {
      const button = document.createElement('button');
      button.id = 'amazon-basepay-button';
      button.setAttribute('aria-label', 'Checkout with Base Pay');
      button.setAttribute('title', 'Checkout with Base Pay - Fast crypto payments');
      
      // Create the Base Pay logo SVG (full logo from BASE.PayLogo.svg)
      const basePayLogo = `
        <svg width="113" height="25" viewBox="0 0 113 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M101.298 24.4597V22.9592H103.206C104.268 22.9592 104.582 22.6203 104.992 21.5555L105.548 20.0792L100.912 7.7605H102.844L106.296 17.6106H106.658L110.28 7.7605H112.211L106.272 22.6929C105.717 24.0724 104.992 24.4597 103.471 24.4597H101.298Z" fill="white"/>
          <path d="M93.3323 20.2244C90.9662 20.2244 89.083 18.8449 89.083 16.5457C89.083 13.8835 91.3767 13.1091 94.0325 12.8186L97.6299 12.4314V11.778C97.6299 10.0354 96.5676 8.92217 94.5878 8.92217C92.8494 8.92217 91.6422 9.76923 91.3525 11.3181H89.5417C89.8556 9.04318 91.7388 7.39746 94.5878 7.39746C97.6782 7.39746 99.3924 9.06738 99.3924 11.8264V17.7558C99.3924 18.4818 99.4648 19.5225 99.5131 19.8129V19.8613H97.654C97.6299 19.4499 97.6299 18.8207 97.6299 18.2398H97.2436C96.5676 19.5225 95.0706 20.2244 93.3323 20.2244ZM90.9904 16.4489C90.9904 17.9252 92.1734 18.7481 93.7427 18.7481C96.1571 18.7481 97.6299 16.9813 97.6299 15.2388V13.7867L94.6844 14.1255C92.4873 14.3917 90.9904 14.9242 90.9904 16.4489Z" fill="white"/>
          <path d="M81.6488 7.39746C85.0772 7.39746 87.4191 10.1323 87.4191 13.7383C87.4191 17.4654 84.9323 20.2244 81.5522 20.2244C79.7414 20.2244 78.148 19.3773 77.4236 17.8284H77.0615V24.4596H75.2266V7.76049H77.0615V9.84183H77.4236C78.1721 8.26872 79.7656 7.39746 81.6488 7.39746ZM81.2625 9.01897C78.8481 9.01897 77.0132 11.0519 77.0132 13.8109C77.0132 16.5699 78.8481 18.6028 81.2625 18.6028C83.87 18.6028 85.5118 16.4731 85.5118 13.8109C85.5118 11.1487 83.8217 9.01897 81.2625 9.01897Z" fill="white"/>
          <path d="M26.9677 20.2243C25.6398 20.2243 24.3602 19.7403 23.6117 18.4576H23.1771V19.8613H20.1592V3.16211H23.1771V9.23673H23.6117C24.3843 7.90564 25.833 7.3974 27.1367 7.3974C30.3961 7.3974 32.5932 10.0112 32.5932 13.6898C32.5932 17.4411 30.1788 20.2243 26.9677 20.2243ZM26.3158 17.5137C28.1749 17.5137 29.5028 15.989 29.5028 13.8109C29.5028 11.6327 28.1508 10.108 26.3158 10.108C24.505 10.108 23.1771 11.5601 23.1771 13.8109C23.1771 16.0616 24.505 17.5137 26.3158 17.5137ZM38.1704 20.2243C35.8526 20.2243 33.9694 18.8206 33.9694 16.5214C33.9694 13.8108 36.0457 12.9396 38.5567 12.6734L42.1058 12.3103V11.6327C42.1058 10.592 41.2608 9.86598 39.7639 9.86598C38.3394 9.86598 37.5185 10.4952 37.2529 11.4391H34.3557C34.6454 9.13993 36.5528 7.3974 39.7639 7.3974C42.8543 7.3974 44.9065 8.89791 44.9065 11.8263V17.7315C44.9065 18.4818 44.9789 19.5224 45.0272 19.8129V19.8613H42.13C42.1058 19.4498 42.1058 19.0626 42.1058 18.6512H41.6712C40.9228 19.8613 39.619 20.2243 38.1704 20.2243ZM38.9913 17.9493C40.9711 17.9493 42.1058 16.4488 42.1058 14.9241V14.3191L39.45 14.6337C37.8082 14.8273 37.0115 15.3114 37.0115 16.3762C37.0115 17.3685 37.8324 17.9493 38.9913 17.9493ZM52.1496 20.2243C49.1075 20.2243 46.9346 18.6996 46.5965 16.3036H49.5662C49.9042 17.3685 51.0149 17.8283 52.1737 17.8283C53.3568 17.8283 54.3225 17.3201 54.3225 16.4246C54.3225 15.5292 53.4051 15.2872 52.1496 15.0693L50.87 14.8515C48.4556 14.4401 46.9587 13.4236 46.9587 11.2455C46.9587 8.87371 49.0351 7.3974 51.9082 7.3974C54.7088 7.3974 56.5679 8.70429 57.0749 10.9793H54.1777C53.8397 10.0838 52.9463 9.72077 51.9323 9.72077C50.701 9.72077 49.9042 10.2532 49.9042 11.0035C49.9042 11.7779 50.532 12.0199 51.8357 12.2377L53.1154 12.4556C55.4573 12.8428 57.2439 13.8109 57.2439 16.1584C57.2439 18.7238 55.1193 20.2243 52.1496 20.2243ZM64.8009 20.2243C61.0828 20.2243 58.6201 17.6831 58.6201 13.7866C58.6201 9.96278 61.2276 7.3974 64.8251 7.3974C68.5915 7.3974 70.7644 10.2048 70.7644 13.9077V14.4401H61.5657C61.7105 16.4488 63.1109 17.6347 64.8009 17.6347C66.2012 17.6347 67.0463 17.1507 67.4567 16.3036H70.5471C69.9194 18.5786 67.674 20.2243 64.8009 20.2243ZM67.8189 12.4314C67.5774 10.8098 66.2978 9.86598 64.8009 9.86598C63.2316 9.86598 61.9037 10.7856 61.6139 12.4314H67.8189Z" fill="white"/>
          <path d="M4.16962 19.8613C3.68675 19.8613 3.44531 19.6193 3.44531 19.1353V8.48655C3.44531 8.00251 3.68675 7.7605 4.16962 7.7605H14.7929C15.2757 7.7605 15.5172 8.00251 15.5172 8.48655V19.1353C15.5172 19.6193 15.2757 19.8613 14.7929 19.8613H4.16962Z" fill="white"/>
        </svg>
      `;
      
      button.innerHTML = basePayLogo;
      
      // Apply Base Pay button styles
      ...
      // Add hover effect
      button.addEventListener('mouseenter', () => {
        button.style.backgroundColor = '#0000CC';
        button.style.transform = 'translateY(-1px)';
        button.style.boxShadow = '0 4px 8px rgba(0, 0, 0, 0.2)';
      });
      ...
      // Add click handler for Base Pay
      button.addEventListener('click', (e) => {
        e.preventDefault();
        this.handleBasePayCheckout();
      });

      return button;
    },

    // Handle Base Pay checkout
    handleBasePayCheckout(): void {
      console.log('Base Pay checkout initiated');
      
      try {
        // Extract product information from Amazon page
        const productInfo = this.extractProductInfo();
        console.log('Product info extracted for Base Pay:', productInfo);
    ...
    injectCheckoutButton(): void {
      ...
      if (subtotalsSection && !document.getElementById('amazon-crypto-checkout-button')) {
        ...
        const basePayButton = this.createBasePayButton();
        
        // Insert the buttons before the subtotals section
        subtotalsSection.parentElement?.insertBefore(button, subtotalsSection);
        subtotalsSection.parentElement?.insertBefore(basePayButton, subtotalsSection);
        console.log('Crypto checkout button and Base Pay button injected above subtotals');
        return;
      }
      ...
      for (const selector of checkoutSelectors) {
        ...
        if (section && !document.getElementById('amazon-crypto-checkout-button')) {
          ...
          section.appendChild(basePayButton);
          console.log('Crypto checkout button and Base Pay button injected (fallback)');
          break;
        }
      }
    },
    ...
    injectSecondCheckoutButton(): void {
      ...
      if (leftSection && rightSection && !document.getElementById('amazon-crypto-checkout-button-2')) {
        ...
        buttonContainer.appendChild(basePayButton);
        ...
        if (parentElement) {
          ...
          console.log('Second crypto checkout button and Base Pay button injected between checkout sections');
        }
      }
    },
